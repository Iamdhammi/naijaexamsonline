...
<body>
	...
	<nav class="navbar navbar-inverse">
		<div class="container">
			...
			<div class="register-btn">
				<ul>
					<li><a href="newtopic.php">Start New Topic</a></li>
				</ul>
			</div>
		</div>
	...
	<div class="topdiv-adjust">
		<div class="container">
			<div class="tag">
				<p><a href="../dashboard/index.php">Home</a> > General Discussion
			</div>
			<ul class="pagination">
				<?php if ($page != 1) { ?>
				<li><a href="forum_user.php?page=<?php echo ($page-1 ); ?>"><?php echo "Previous"; ?></a></li> 
				<?php } ?>
				<?php for ($page = 1; $page <= $number_of_pages; $page++){  ?>

				<li <?php if($_GET['page'] == $page) { echo "class = 'active'";} ?>><a href="forum_user.php?page=<?php echo $page; ?>"><?php echo $page; ?></a></li>
				<?php } ?>
				<?php if ($page != 1 && $_GET['page'] < $number_of_pages) { ?>
				<li><a href="forum_user.php?page=<?php echo ($_GET['page'] + 1 ); ?>"><?php echo "Next"; ?></a></li> 
				<?php } ?>
				...
				<div class="col-lg-8">
					...
					<div class="topics">
						<div class="row">
							...
							<a href="discussion.php?id=<?php echo $topic_id; ?>&commentpage=1">
							<div class="col-lg-8 topic-content2">
								<h4>
							...
							?>
							<div class="col-lg-2 topic-content3">
