            ...
            <div>
				<section style="margin-top: 30px;">
					<div class="container">
						...
						<div class="pastquestion_flex">
							
								<div style="background-image:url(images/waec.jpg);">
								<div class="past-overlay"></div>
								<div class="past-content">
									<a href="pastquestioncat.php?cat=waec">	WAEC </a>
								</div>
							
							</div>
							
								<div style="background-image:url(images/neco.jpeg);">
									<div class="past-overlay"></div>
									<div class="past-content">
										<a href="pastquestioncat.php?cat=neco"> neco </a>
									</div>
								</div>
							
							
								<div style="background-image:url(images/utme.jpg);">
									<div class="past-overlay"></div>
									<div class="past-content">
										<a href="pastquestioncat.php?cat=utme"> Utme </a>
									</div>
								</div>
						</div>
						...
						<div class="pastquestion_flex">
								...
								<div style="background-image:url(images/NABTEB.jpg);">
									<div class="past-overlay"></div>
									<div class="past-content">
									<a href="pastquestioncategory.php?cat=nabtab">nabtab</a>
									</div>	
								</div>
								...
								<div style="background-image:url(images/waec.jpg);">
									<div class="past-overlay"></div>
									<div class="past-content">
									<a href="pastquestioncategory.php?cat=bece">	bece </a>
									</div>
								</div>
							</a>
								...
								<div style="background-image:url(images/waec.jpg);">
									<div class="past-overlay"></div>
									<div class="past-content">
									<a href="pastquestioncategory.php?cat=juniorwaec">	Junior Waec </a>
									</div>	
								</div>
						...
						<div class="pastquestion_flex">
								...
								<div style="background-image:url(images/waec.jpg);">
									<div class="past-overlay"></div>
									<div class="past-content">
									<a href="pastquestioncategory.php?cat=postutme">	postutme </a>
									</div>
								</div>
							<!-- </a> -->
						</div>
